...
require (
	...
	github.com/grafana/alerting v0.0.0-20260304185607-3b455cb55a82 // @grafana/alerting-backend
	...
	github.com/grafana/grafana-azure-sdk-go/v2 v2.4.0 // @grafana/partner-datasources
